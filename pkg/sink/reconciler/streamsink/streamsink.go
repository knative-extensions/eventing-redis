...
import (
	...
	streamsinkreconciler "knative.dev/eventing-redis/pkg/sink/client/injection/reconciler/sinks/v1alpha1/redisstreamsink"
	"knative.dev/eventing-redis/pkg/sink/reconciler/streamsink/resources"
)
