...
import (
	...
	"knative.dev/eventing-redis/pkg/sink/client/clientset/versioned/scheme"
)

type SourcesV1alpha1Interface interface {
	RESTClient() rest.Interface
	RedisStreamSinksGetter
}
...
func (c *SourcesV1alpha1Client) RedisStreamSinks(namespace string) RedisStreamSinkInterface {
	return newRedisStreamSinks(c, namespace)
}
