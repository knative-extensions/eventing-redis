...
var redisstreamsinksResource = v1alpha1.SchemeGroupVersion.WithResource("redisstreamsinks")

var redisstreamsinksKind = v1alpha1.SchemeGroupVersion.WithKind("RedisStreamSink")
