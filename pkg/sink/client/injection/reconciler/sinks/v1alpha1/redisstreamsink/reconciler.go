...
import (
	...
	versioned "knative.dev/eventing-redis/pkg/sink/client/clientset/versioned"
	sinksv1alpha1 "knative.dev/eventing-redis/pkg/sink/client/listers/sinks/v1alpha1"
...
// controller reconciling v1alpha1.RedisStreamSink.
type Interface interface {
	// ReconcileKind implements custom logic to reconcile v1alpha1.RedisStreamSink. Any changes
	// to the objects .Status or .Finalizers will be propagated to the stored
	// object. It is recommended that implementors do not call any update calls
	// for the Kind inside of ReconcileKind, it is the responsibility of the calling
	// controller to propagate those properties. The resource passed to ReconcileKind
	// will always have an empty deletion timestamp.
	ReconcileKind(ctx context.Context, o *v1alpha1.RedisStreamSink) reconciler.Event
}

// Finalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1alpha1.RedisStreamSink.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1alpha1.RedisStreamSink. Any changes
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1alpha1.RedisStreamSink) reconciler.Event
}

// ReadOnlyInterface defines the strongly typed interfaces to be implemented by a
// controller reconciling v1alpha1.RedisStreamSink if they want to process resources for which
// they are not the leader.
type ReadOnlyInterface interface {
	// ObserveKind implements logic to observe v1alpha1.RedisStreamSink.
	// This method should not write to the API.
	ObserveKind(ctx context.Context, o *v1alpha1.RedisStreamSink) reconciler.Event
}

type doReconcile func(ctx context.Context, o *v1alpha1.RedisStreamSink) reconciler.Event

// reconcilerImpl implements controller.Reconciler for v1alpha1.RedisStreamSink resources.
type reconcilerImpl struct {
	...
	Lister sinksv1alpha1.RedisStreamSinkLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister sinksv1alpha1.RedisStreamSinkLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.RedisStreamSinks(s.namespace)
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.RedisStreamSink, desired *v1alpha1.RedisStreamSink) error {
	existing = existing.DeepCopy()
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		// The first iteration tries to use the injectionInformer's state, subsequent attempts fetch the latest state via API.
		if attempts > 0 {

			getter := r.Client.SourcesV1alpha1().RedisStreamSinks(desired.Namespace)
		...
		updater := r.Client.SourcesV1alpha1().RedisStreamSinks(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.RedisStreamSink, desiredFinalizers sets.Set[string]) (*v1alpha1.RedisStreamSink, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.RedisStreamSink, desiredFinalizers sets.Set[string]) (*v1alpha1.RedisStreamSink, error) {
	...
	patcher := r.Client.SourcesV1alpha1().RedisStreamSinks(resource.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.RedisStreamSink, desiredFinalizers sets.Set[string]) (*v1alpha1.RedisStreamSink, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1alpha1.RedisStreamSink) (*v1alpha1.RedisStreamSink, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.RedisStreamSink, reconcileEvent reconciler.Event) (*v1alpha1.RedisStreamSink, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
	...
	if err != nil {
		...
		getter := r.Client.SourcesV1alpha1().RedisStreamSinks(resource.Namespace)
