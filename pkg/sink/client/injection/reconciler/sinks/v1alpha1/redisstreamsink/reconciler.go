...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.RedisStreamSink, desiredFinalizers sets.String) (*v1alpha1.RedisStreamSink, error) {
	// Don't modify the informers copy.
