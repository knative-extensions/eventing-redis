...
var redisstreamsourcesResource = v1alpha1.SchemeGroupVersion.WithResource("redisstreamsources")

var redisstreamsourcesKind = v1alpha1.SchemeGroupVersion.WithKind("RedisStreamSource")
...
func (c *FakeRedisStreamSources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(redisstreamsourcesResource, c.ns, name, opts), &v1alpha1.RedisStreamSource{})
