...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.RedisStreamSource, desiredFinalizers sets.String) (*v1alpha1.RedisStreamSource, error) {
	// Don't modify the informers copy.
