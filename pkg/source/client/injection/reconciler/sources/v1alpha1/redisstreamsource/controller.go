...
import (
	...
	versionedscheme "knative.dev/eventing-redis/pkg/source/client/clientset/versioned/scheme"
	client "knative.dev/eventing-redis/pkg/source/client/injection/client"
	redisstreamsource "knative.dev/eventing-redis/pkg/source/client/injection/informers/sources/v1alpha1/redisstreamsource"
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.knative.dev.RedisStreamSource"),
	)
