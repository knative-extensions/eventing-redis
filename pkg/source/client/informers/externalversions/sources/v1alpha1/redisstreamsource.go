...
import (
	...
	internalinterfaces "knative.dev/eventing-redis/pkg/source/client/informers/externalversions/internalinterfaces"
	v1alpha1 "knative.dev/eventing-redis/pkg/source/client/listers/sources/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SourcesV1alpha1().RedisStreamSources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SourcesV1alpha1().RedisStreamSources(namespace).Watch(context.TODO(), options)
			},
		},
