...
import (
	...
	versioned "knative.dev/eventing-redis/sink/pkg/client/clientset/versioned"
	sinksv1alpha1 "knative.dev/eventing-redis/sink/pkg/client/listers/sinks/v1alpha1"
...
// controller finalizing v1alpha1.RedisStreamSink if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1alpha1.RedisStreamSink.
	// This method should not write to the API.
	ObserveFinalizeKind(ctx context.Context, o *v1alpha1.RedisStreamSink) reconciler.Event
}
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.RedisStreamSink, desired *v1alpha1.RedisStreamSink) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		_, err = updater.UpdateStatus(ctx, existing)
		return err
	})
}
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.RedisStreamSink) (*v1alpha1.RedisStreamSink, error) {

	getter := r.Lister.RedisStreamSinks(resource.Namespace)
	...
	resource, err = patcher.Patch(ctx, resourceName, types.MergePatchType, patch)
	if err != nil {
