...
import (
	...
	versionedscheme "knative.dev/eventing-redis/sink/pkg/client/clientset/versioned/scheme"
	client "knative.dev/eventing-redis/sink/pkg/client/injection/client"
	redisstreamsink "knative.dev/eventing-redis/sink/pkg/client/injection/informers/sinks/v1alpha1/redisstreamsink"
...
const (
	defaultControllerAgentName = "redisstreamsink-controller"
	defaultFinalizerName       = "redisstreamsinks.sources.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	redisstreamsinkInformer := redisstreamsink.Get(ctx)

	lister := redisstreamsinkInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.knative.dev.RedisStreamSink"),
	)
